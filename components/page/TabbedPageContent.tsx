...
import { PageContent, IntroSection, ComparisonGridSection, FeaturedProductsSection, ContactAdvisorSection } from '@/lib/types/page';
...
export default function TabbedPageContent({ content }: TabbedPageContentProps) {
  return (
